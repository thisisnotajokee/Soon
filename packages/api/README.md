...
12. `POST /self-heal/run` (manualny trigger cyklu self-heal; anomalies + status per playbook)
13. `GET /self-heal/runs/latest?limit=20` (historia self-heal runów; `playbookId + status`)
